class UserCategoriesController < ApplicationController
  ...
  def create
    ...
    categories = UserCategories.find(params[:category_ids])
    respond_to do |format|
      if @user_category.save
        format.html do
          redirect_to user_category_url(@user_category),
                      notice: 'User category was successfully created.'
        end
  ...
  def update
    respond_to do |format|
      if @user_category.update(user_category_params)
        format.html do
          redirect_to user_category_url(@user_category),
                      notice: 'User category was successfully updated.'
        end
    ...
    respond_to do |format|
      format.html do
        redirect_to user_categories_url,
                    notice: 'User category was successfully destroyed.'
      end
  ...
  def user_category_params
    params.require(:user_category).permit(:user_id, :category_ids[])
  end
end
